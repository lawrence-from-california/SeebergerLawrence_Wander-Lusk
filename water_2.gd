...
@export var surface_color: Color = Color("20b2abdd")
@export var water_fill_color: Color = Color("25859687")
...
func initiate_water() -> void:
	...
	new_area.collision_layer = 0b00000110
	new_area.collision_mask = 0b00000110
	add_child(new_area)
...
func _on_body_exited(body: Node2D) -> void:
	...
	splash(body.global_position,  vy * player_splash_multiplier)
	if body is MainCharacter:
		player.swimmer=false
		player.velocity.y = 0.8*(player.JUMP_VELOCITY)
